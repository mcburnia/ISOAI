    ...
    <aside className="fixed left-0 top-0 h-screen w-60 bg-sidebar text-sidebar-foreground flex flex-col z-50">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-2.5 px-2.5 py-2 rounded-md text-sm transition-colors ${
                    isActive
                      ? 'bg-kmi-bright text-white font-medium'
      ...
      <div className="border-t border-sidebar-accent px-3 py-3">
        <div className="flex items-center gap-2.5 px-2">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-kmi-bright flex items-center justify-center text-xs font-semibold text-white flex-shrink-0">
